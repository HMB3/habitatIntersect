...
analysis_test <- c('Ausejanus femoralis', 'Mutusca brevicornis', 'Rayieria basifer')
...
Lygaeidae_ALA            <- COORD.CLEAN  %>% as.data.frame () %>% filter(searchTaxon == 'Lygaeidae'  | family == 'Lygaeidae')
Malandiola_ALA           <- SDM.SPAT.OCC.BG  %>% as.data.frame () %>% filter(searchTaxon == 'Malandiola' | genus  == 'Malandiola')
Miridae_ALA              <- COORD.CLEAN  %>% as.data.frame () %>% filter(searchTaxon == 'Miridae'    | family == 'Miridae')
