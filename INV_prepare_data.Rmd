...
ALA.LAND.FAM <- combine_ala_records(species_list      =  all.insect.families,
...
ALA.LAND.GEN <- combine_ala_records(species_list      = target.insect.genera,
...
ALA.LAND.SPP <- combine_ala_records(species_list      = target.insect.spp,
...
write_csv(GLOBAL_NICHES_TARG_TAXA, './output/veg_climate_topo_maxent/Habitat_suitability/GLOBAL_NICHES_TARG_ALL_TAXA.csv')
