...
for(taxa in target.insect.families) {
  ...
  if(taxa %in% unique(SDM.SPAT.OCC.BG.GDA$searchTaxon)) {
    ...
    taxa_shp <- paste0('G:/North_east_NSW_fire_recovery/output/veg_climate_topo_maxent/Habitat_suitability/SDM_point_data/',
    ...
    if(!file.exists(taxa_shp)) {
      ...
      writeOGR(obj    = taxa_occ,
               dsn    = 'G:/North_east_NSW_fire_recovery/output/veg_climate_topo_maxent/Habitat_suitability/SDM_point_data',
