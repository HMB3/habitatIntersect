...
target_reptiles  <- c('Phyllurus platurus',  'Eulamprus tympanum',      'Hoplocephalus bungaroides', 'Dysdalia rhodogaster', 
...
habitat_reptiles <- c('Phyllurus platurus',  'Eulamprus tympanum',      'Hoplocephalus bungaroides', 'Dysdalia rhodogaster', 
                      'Morelia spilota',     'Pseudechis porphyriacus', 'Varanus rosenbergi')
...
COMBO.RASTER.BG = combine_records_extract(ala_df           = BACKG.SPP,
                                          site_df          = 'NONE',
                                          thin_records     = FALSE,
                                          template_raster  = template_raster_1km_WGS84,
                                          world_raster     = aus.climate.veg.grids,
                                          prj              = CRS("+init=epsg:4326"),
                                          taxa_list        = BACKG.SPP$searchTaxon,
                                          taxa_level       = 'species', 
...
writeOGR(obj    = SDM.SPAT.OCC.TARG.REPTILE.BG,
         dsn    = 'G:/GITHUB/North_east_NSW_fire_recovery/reptile_maxent/results',
...
writeOGR(obj    = SDM.SPAT.OCC.TARG.REPTILE.BG,
         dsn    = 'G:/GITHUB/North_east_NSW_fire_recovery/reptile_maxent/results',
         layer  = 'SDM_SPAT_OCC_BG_GDA_ALL_CONTROL_REPTILE_TAXA', 
         driver = 'ESRI Shapefile', overwrite_layer = TRUE)
