...
SDM.SPAT.OCC.BG.INVERT.GDA  <- readRDS('./output/results/SDM_SPAT_OCC_BG_GDA_ALL_TARGET_INVERT_TAXA.rds')
...
SDM.SPAT.OCC.ALL.REPTILE.BG <- prepare_sdm_table(coord_df          = COORD.CLEAN,
                                                 taxa_list         = COORD.CLEAN$searchTaxon,
                                                 ...
                                                 background_points = SDM.SPAT.OCC.BG.INVERT.GDA, 
                                                 save_data         = TRUE,
...
Hoplocephalus_bungaroides <- SDM.SPAT.OCC.TARGET.REPTILE.BG %>% subset(., searchTaxon == 'Pseudechis porphyriacus') 
