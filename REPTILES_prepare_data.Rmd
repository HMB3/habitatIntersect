...
SDM.SPAT.OCC.TARGET.REPTILE.BG %>% subset(., searchTaxon == 'Hoplocephalus bungaroides') %>% nrow()
SDM.SPAT.OCC.TARGET.REPTILE.BG %>% subset(., searchTaxon == 'Pseudechis porphyriacus')   %>% nrow()
