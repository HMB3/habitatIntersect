...
## Some taxa may be missing data for year, etc.
...
## Also, some of the records don't have a 'year' attribute, for some taxa, tha causes a lot of records to be lost.
...
## Extract enviro data for background taxa
COMBO.RASTER.BG = combine_records_extract(ala_df           = ALA.LAND.BACKG.SPP,
                                          site_df          = 'NONE',
                                          thin_records     = FALSE,
                                          template_raster  = template_raster_1km_WGS84,
                                          world_raster     = aus.climate.veg.grids,
                                          ...
                                          raster_divide    = FALSE,
                                          save_data        = FALSE,
                                          save_run         = "BACKGROUND_REPTILE_SPECIES",
                                          data_path        = "./output/results/")
...
## Do the same for the BG points
COORD.CLEAN.BG = coord_clean_records(records    = COMBO.RASTER.BG,
                                     capitals   = 10000,  
                                     centroids  = 5000,   
                                     save_data  = FALSE,
                                     save_run   = "BACKGROUND_REPTILE_SPECIES",
...
SPATIAL.CLEAN.BG = check_spatial_outliers(occ_df       = COORD.CLEAN.BG,
                                          land_shp     = LAND,
                                          site_records = TRUE, 
                                          clean_path   = './data/ALA/Check_Plots/',
                                          plot_points  = FALSE,
...
COORD.CLEAN.BG = COORD.CLEAN.BG[!COORD.CLEAN.BG$searchTaxon %in% taxa_list, ]


## Create SDM table for all the backhround reptile species
SDM.SPAT.OCC.ALL.REPTILE.BG <- prepare_sdm_table(coord_df          = COORD.CLEAN.BG,
                                                 taxa_list         = COORD.CLEAN.BG$searchTaxon,
...
## Combine occ data with the bg data for the target reptiles
SDM.SPAT.OCC.TARG.REPTILE.BG <- prepare_sdm_table(coord_df          = COORD.CLEAN,
                                                  taxa_list         = target_reptiles,
                                                  ...
                                                  save_run          = "TEST_REPTILE_TAXA",
                                                  site_records      = FALSE,
                                                  read_background   = TRUE,
                                                  background_points = SDM.SPAT.OCC.ALL.REPTILE.BG, 
                                                  save_data         = TRUE,
...
writeOGR(obj    = SDM.SPAT.OCC.TARG.REPTILE.BG,
