...
veg_back_dir <- './output/full_maxent/back_sel_models'
veg_full_dir <- './output/full_maxent/full_models'
...
run_sdm_analysis(species_list            = rev(analysis_taxa),
                 maxent_dir              = 'output/full_maxent/full_models',     
                 bs_dir                  = 'output/full_maxent/back_sel_models',
                 sdm_df                  = SDM.SPAT.OCC.BG,
                 
                 sdm_predictors          = names(aus.climate.veg.grids),
                 
                 backwards_sel           = TRUE,      
                 template_raster         = template_raster_1km_GDA,
                 cor_thr                 = 0.8,  
                 pct_thr                 = 5, 
                 k_thr                   = 4, 
                 min_n                   = 20,  
