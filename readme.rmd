...
analysis_spp <- str_trim(all.insect.plant.spp) 
analysis_spp
...
## saveRDS(COMBO.RASTER.SUBSET, './output/results/COMBO_RASTER_SUBSET_TARGET_INSECT_FAMILIES.rds')
