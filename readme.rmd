...
species under current environmental conditions. 
There are three ways to estimate habitat suitability :
...
**Figure 1.** Example of a continuous climatic suitability map for one plant species under 
