...
Let's use all the insect famlies that we think might be threatened by the 2019/2020 fires. 

\

```{r message=TRUE, echo=TRUE, warning=FALSE, eval=TRUE}

## Use lists of taxa at all levels
...
COORD.CLEAN = coord_clean_records(records    = COMBO.RASTER.SUBSET,
                                  capitals   = 10000,  
                                  centroids  = 5000,   
                                  save_data  = FALSE,
...
We can also plot the environmental ranges of each species. The next cleaning function 
