...
Let's use all the insect famlies that we think might be threatned by the 2019/2020 fires. 
...
analysis_spp <- str_trim(target.insect.genera) 
# analysis_spp <- all.insect.families
analysis_spp
