...
tryCatch(
  ...
  error = function(cond) {
    ...
    file.create(file.path("output/full_maxent/back_sel_models/mapping_failed_current.txt"))
    cat(cond$message, file = file.path("output/full_maxent/back_sel_models/mapping_failed_current.txt"))
