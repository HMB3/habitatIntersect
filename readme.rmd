...
the habitat suitability of large suites of species under current environmental conditions. 
...
Given there are only ~100 species in our analysis, we need mnay more taxa to generate enough background points.
We're analyzing insects, so we can get ALL the insect records from the ALA. A background point is 
...
ALA.BG = combine_background_records(background_df     = head(insect_data_standard_columns, 10000),
