...
download_ALA_all_genera(species_list  = analysis_spp,
                        your_email    = 'hugh.burley@gmail.com',
...
download_ALA_all_families(species_list   = analysis_spp,
                          your_email     = 'hugh.burley@gmail.com',
...
ALA.LAND.FAM <- combine_ala_records(species_list      = analysis_spp,
...
ALA.LAND.GEN <- combine_ala_records(species_list      = analysis_spp,
...
ALA.LAND.SPP <- combine_ala_records(species_list      = analysis_spp,
...
COMBO.RASTER.SPP = combine_records_extract(ala_df          = ALA.LAND.GEN,
...
COORD.CLEAN = coord_clean_records(records    = COMBO.RASTER.GEN,
                                  capitals   = 10000,  
                                  centroids  = 5000,   
                                  save_data  = FALSE,
...
## SDM.SPAT.OCC.BG = readRDS('./output/results/SDM_SPAT_OCC_BG_ALL_INSECT_SPP.rds')
## SDM.SPAT.OCC.BG = readRDS('./output/results/SDM_SPAT_OCC_BG_ALL_PLANT_SPP.rds')
## SDM.SPAT.OCC.BG = readRDS('./output/results/SDM_SPAT_OCC_BG_ALL_INSECT_SPP.rds')
## SDM.SPAT.OCC.BG = readRDS('./output/results/SDM_SPAT_OCC_BG_ALL_INSECT_SPP.rds')
