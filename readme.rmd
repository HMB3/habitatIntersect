...
analysis_taxa <- str_trim(target.insect.spp)
analysis_taxa
...
aus.veg.grids <- stack(
  list.files('./data/Remote_sensing/sdm_predictors/', 
             '_subset.tif', full.names = TRUE))
...
## 
VEG.RASTER.SPP = combine_records_extract(ala_df          = head(ALA.LAND.SPP, 500),
                                         site_df         = head(all_insect_site_df_species, 500),
                                         thin_records    = FALSE,
                                         template_raster = template_raster_1km_WGS84,
                                         world_raster    = aus.veg.grids,
                                         prj             = CRS("+init=epsg:4326"),
                                         species_list    = analysis_taxa,
...
## Set the raster temp directory to a location not on the partition, to save space
