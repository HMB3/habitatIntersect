...
## Put the maxent.jar file in the dismo folder
# get_maxent('3.4.1')
# Sys.setenv(JAVA_HOME='C:\\Program Files\\Java\\jre1.8.0_321')


## Set temporary raster dir for the terra package
rasterOptions(tmpdir = 'E:/Bush_fire_analysis/TEMP')
terraOptions(memfrac = 0.5, 
             tempdir = 'E:/Bush_fire_analysis/North_east_NSW_fire_recovery/TEMP')
...
records_dir   <- './output/invert_maxent_raster_update/Habitat_suitability/SDM_point_data/'
...
dir_lists   <- c(ALA_dir,  check_dir,   back_dir,  habitat_dir, records_dir,
