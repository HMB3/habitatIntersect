...
# saveRDS(GLOB.NICHE.ALL,   './output/invert_maxent/Habitat_suitability/GLOBAL_NICHES_TARG_ALL_TAXA.rds')
# write_csv(GLOB.NICHE.ALL, './output/invert_maxent/Habitat_suitability/GLOBAL_NICHES_TARG_ALL_TAXA.csv')
...
for(taxa in target.insect.families) {
  ...
  if(taxa %in% unique(SDM.SPAT.OCC.BG.GDA$searchTaxon)) {
    ...
    taxa_shp <- paste0('G:/GITHUB/North_east_NSW_fire_recovery/output/invert_maxent/Habitat_suitability/SDM_point_data/',
    ...
    if(!file.exists(taxa_shp)) {
      ...
      writeOGR(obj    = taxa_occ,
               dsn    = 'G:/GITHUB/North_east_NSW_fire_recovery/output/invert_maxent/Habitat_suitability/SDM_point_data',
