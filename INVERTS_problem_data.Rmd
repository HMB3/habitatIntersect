...
table(ALA.LAND.INV.SPP$SOURCE);
table(ALA.LAND.INV.GENUS$SOURCE);
table(ALA.LAND.INV.FAM$SOURCE)
...
COMBO.RASTER.FAM = combine_records_extract(ala_df           = ALA.LAND.INV.SPP,
                                           add_sites        = TRUE,
                                           filter_taxo      = FALSE,
