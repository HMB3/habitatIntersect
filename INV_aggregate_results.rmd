...
# Assess the exent of habitat burnt for each species

\

For each species, we want to caclulate the % of suitable habitat that was burnt by the
2019-2020 fires. We could use raster multiplication to achieve this...


Create a function that loops through all species, and multiples the thresh holded SDM rasters by
...
Next let's get the rasters to compare with SDM modelling :
...
## VALUES : 1-4, burn intensity from 2019-2020 fires at 10m resolution
...
# The State Vegetation Type Map (SVTM)  of Plant Community Types across NSW at 5m pixels
