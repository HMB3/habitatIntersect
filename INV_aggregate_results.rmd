...
## Set temporary raster dir
terraOptions()$tempdir = 'G:/North_east_NSW_fire_recovery/TEMP'
...
#   list.files('./output/veg_climate_topo_maxent/Habitat_suitability/SDM_threshold_10m', 
#              'current_suit_not_novel_above', full.names = TRUE))

test_sdm <- raster('./output/veg_climate_topo_maxent/Habitat_suitability/SDM_threshold_10m/Acanthosomatidae_current_suit_not_novel_above_0_3041_10m_.tif')
