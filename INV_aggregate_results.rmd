...
## Create a stack of all the rasters needed to calculate habitat
## Try stacking the composite bands, + the SDMs
study.veg.sdm <- stack('./output/veg_climate_topo_maxent/Habitat_suitability/10m/Resampled/Veg_fire_SDM_composite.tif')

## Check the raster output
# plot(aus.veg.grids$Acanthosomatidae_current_not_novel_10m)
