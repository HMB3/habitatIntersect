...
## 
SDM.SPAT.OCC.REPTILE.BG = readRDS('./output/reptile_maxent/results/SDM_SPAT_OCC_BG_TEST_REPTILE_TAXA.rds')
...
run_sdm_analysis(taxa_list               = target_reptiles,
                 ...
                 sdm_df                  = SDM.SPAT.OCC.REPTILE.BG,
...
reptile_map_taxa <- REPTILES.MAXENT.RESULTS$searchTaxon %>% gsub(" ", "_", .,)
...
tryCatch(
  ...
  error = function(cond) {
    ...
    cat(cond$message, file = file.path("output/reptile_maxent/back_sel_models/inv_mapping_failed_current.txt"))
