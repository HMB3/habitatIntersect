...
## Should be 280m*280m, It should havle a value of 1 for land, and NA for the ocean
template_raster_250m         <- raster('./data/CSIRO_layers/250m/template_250m_raster.tif')
...
results_dir   <- './output/reptile_maxent_raster_update/results/'
habitat_dir   <- './output/reptile_maxent_raster_update/Habitat_suitability/'
threshold_dir <- './output/reptile_maxent_raster_update/Habitat_suitability/SDM_thresholds/'
intersect_dir <- './output/reptile_maxent_raster_update/Habitat_suitability/FESM_SDM_intersect/'


REPTILES.MAXENT.RESULTS <- compile_sdm_results(taxa_list    = target_reptiles,
                                               results_dir  = 'output/reptile_maxent_raster_update/back_sel_models',
                                               data_path    = "./output/reptile_maxent_raster_update/Habitat_suitability/",
                                               sdm_path     = "./output/reptile_maxent_raster_update/back_sel_models/",
                                               save_data    = TRUE,
...
tryCatch(
  ...
  project_maxent_current_grids_mess(taxa_list       = rev(reptiles_map_taxa),    
                                    ...
                                    output_path     = paste0(threshold_dir, 'reptiles_sdm_novel_combo.gpkg'),
                                    poly_path       = 'data/Feature_layers/Study_areas/AUS_2016_AUST.shp',
                                    epsg            = 3577),
