...
SDM.SPAT.OCC.TARGET.REPTILE.BG = readRDS('./output/reptile_maxent/results/SDM_SPAT_OCC_BG_TARGET_CONTROL_REPTILE_TAXA.rds')


## Are the control taxa present? And the extra records?
'Pseudechis porphyriacus'   %in% SDM.SPAT.OCC.TARGET.REPTILE.BG$searchTaxon
'Hoplocephalus bungaroides' %in% SDM.SPAT.OCC.TARGET.REPTILE.BG$searchTaxon
...
## Run species-level models for REPTILES
run_sdm_analysis(taxa_list               = rev(target_reptiles),
                 taxa_level              = 'species',
                 maxent_dir              = 'output/reptile_maxent/full_models',     
                 bs_dir                  = 'output/reptile_maxent/back_sel_models',
                 sdm_df                  = SDM.SPAT.OCC.TARGET.REPTILE.BG,
...
## Threshold the REPTILESebrate SDM models to be either 0 or 1
