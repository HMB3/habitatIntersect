...
tryCatch(
  ...
  project_maxent_current_grids_mess(taxa_list       = rev(reptiles_map_taxa),    
                                    ...
                                    output_path     = 'output/reptile_maxent/Habitat_suitability/SDM_thresholds/sdm_novel_combo.gpkg',
                                    poly_path       = 'data/Spatial_data/Study_areas/AUS_2016_AUST.shp',
                                    epsg            = 3577),
...
habitat_threshold(taxa_list     = sort(unique(REPTILES.MAXENT.RESULTS$searchTaxon)),
                  ...
                  maxent_path   = './output/reptile_maxent/back_sel_models/',
                  output_path   = 'output/reptile_maxent/Habitat_suitability/SDM_thresholds/reptile_sdm_thresholds_combo.gpkg',
                  poly_path     = 'data/Spatial_data/Study_areas/AUS_2016_AUST.shp',
                  epsg          = 3577)
