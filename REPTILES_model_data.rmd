...
tryCatch(
  ...
  project_maxent_current_grids_mess(taxa_list       = rev(reptiles_map_taxa),    
                                    ...
                                    output_path     = 
                                      'output/reptile_maxent/Habitat_suitability/SDM_thresholds/reptiles_sdm_novel_combo.gpkg',
                                    poly_path       = 'data/Spatial_data/Study_areas/AUS_2016_AUST.shp',
                                    epsg            = 3577),
...
thresholded_sdms <- list.files(path    = './output/reptile_maxent/back_sel_models/',
...
file.copy(from      = thresholded_sdms, 
          to        = 'output/reptile_maxent/Habitat_suitability/SDM_thresholds/', 
          overwrite = TRUE, 
          recursive = TRUE, 
          copy.mode = TRUE)
