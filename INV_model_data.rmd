...
run_sdm_analysis(taxa_list               = rev(sort(all.insect.families)),
                 taxa_level              = 'family',
...
run_sdm_analysis(taxa_list               = sort(target.insect.genera),
                 taxa_level              = 'genus',
                 maxent_dir              = 'output/veg_climate_topo_maxent/full_models',     
                 bs_dir                  = 'output/veg_climate_topo_maxent/back_sel_models',
                 sdm_df                  = SDM.SPAT.OCC.BG.GDA,
...
MAXENT.RESULTS = compile_sdm_results(taxa_list    = all.insect.families,
