...
run_sdm_analysis(taxa_list               = rev(sort(target.host.plants)),
                 taxa_level              = 'species',
...
## To do :
## Add to this table needs added to it :
## Host taxa
## Veg Community
...
MAXENT.RESULTS = compile_sdm_results(taxa_list    = analysis_taxa,
                                     ...
                                     # data_path    = "./output/plant_maxent/Habitat_suitability/",
...
# write_csv(MAXENT.RESULTS, './output/plant_maxent/Habitat_suitability/MAXENT_RESULTS_TARG_PLANT_ALA_TAXA.csv')
...
MAXENT.RESULTS.HOSTS <- MAXENT.RESULTS %>% left_join(., host_plants, by = "searchTaxon") %>% 
