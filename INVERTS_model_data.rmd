...
run_sdm_analysis(taxa_list               = sort(target.insect.families),
                 taxa_level              = 'family',
                 maxent_dir              = 'output/invert_maxent/full_models',     
                 bs_dir                  = 'output/invert_maxent/back_sel_models',
...
INVERT.MAXENT.FAM.RESULTS <- compile_sdm_results(results_dir  = 'output/invert_maxent/back_sel_models',
                                                 data_path    = "./output/invert_maxent/Habitat_suitability/",
                                                 sdm_path     = "./output/invert_maxent/back_sel_models/",
                                                 save_data    = FALSE,
                                                 save_run     = "INVERT_ANALYSIS_TAXA")
...
tryCatch(
  ...
  error = function(cond) {
    ...
    file.create(file.path("output/invert_maxent/back_sel_models/mapping_failed_current.txt"))
    cat(cond$message, file = file.path("output/invert_maxent/back_sel_models/inv_mapping_failed_current.txt"))
