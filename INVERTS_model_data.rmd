...
run_sdm_analysis(taxa_list               = sort(target.host.plants)[1],
                 taxa_level              = 'species',
...
INVERT.MAXENT.FAM.RESULTS <- compile_sdm_results(results_dir  = 'output/veg_climate_topo_maxent/back_sel_models',
                                                 data_path    = "./output/veg_climate_topo_maxent/Habitat_suitability/",
                                                 sdm_path     = "./output/veg_climate_topo_maxent/back_sel_models/",
                                                 save_data    = FALSE,
                                                 save_run     = "INVERT_ANALYSIS_TAXA")
