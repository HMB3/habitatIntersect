...
## Valley bottom data
aus.vbf   <- raster('./data/Remote_sensing/Topography/mrvbf_int_resample.tif')
study.vbf <- raster('./data/Remote_sensing/Topography/mrvbf_int_resample.tif')
...
study.climate.veg.grids <- stack(study.grids.current, study.veg.grids)
...
## FESM data : a stack of grids for fire extent, in GDA Albers projection
# fesm.grids <- stack(list.files('./data/Remote_sensing/Veg_data/FESM', 
#                                '_GDA.tif', full.names = TRUE))
...
a data frame of all species records, and prepares a table in the 'species with data' (swd) format taht