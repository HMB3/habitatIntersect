...
SDM.SPAT.OCC.BG.GDA       = readRDS('./reptile_maxent/results/SDM_SPAT_OCC_BG_GDA_ALL_TARGET_INVERT_TAXA.rds')
SDM.PLANT.SPAT.OCC.BG.GDA = readRDS('./reptile_maxent/results/SDM_SPAT_OCC_BG_TARGET_HOST_PLANTS.rds')
