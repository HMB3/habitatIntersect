...
GBAM        <- raster('./output/REPTILE_maxent/Habitat_suitability/aligned_rasters/GBAM_100m.tif')
...
FESM_2_100m     <- raster('./output/REPTILE_maxent/Habitat_suitability/aligned_rasters/FESM_2_100m_align.tif')
FESM_100m       <- raster('./output/REPTILE_maxent/Habitat_suitability/aligned_rasters/FESM_100m_align.tif')
FESM_100m_align <- readRDS('./output/REPTILE_maxent/Habitat_suitability/aligned_rasters/FESM_100m_align.rds')


## Read in the SDM data, to intersect with the Veg layers
SVTM_Veg_Class_GDA             <- readRDS('./output/REPTILE_maxent/Habitat_suitability/aligned_rasters/SVTM_Veg_Class_GDA.rds')
SDM.SPAT.OCC.TARGET.REPTILE.BG <- readRDS('./output/reptile_maxent/results/SDM_SPAT_OCC_BG_REPTILE_GDA.rds')


## Check projections and resolutions
projection(FESM_100m);projection(study_sdm_binary[[1]]);projection(GBAM);projection(SDM.SPAT.OCC.TARGET.REPTILE.BG)
